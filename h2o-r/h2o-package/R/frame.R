...
#' @param \dots arguments passed to \code{as.data.frame} method.
#' @export
#' @examples 
#' h2o.init()
#' hi <- as.h2o(iris)
...
#' Is H2O Frame object
#'
#' Test if H2OFrame class.
#'
#' @param x An \code{R} object.
#' @export
is.h2o <- is.H2OFrame <- function(x) inherits(x, "H2OFrame")
